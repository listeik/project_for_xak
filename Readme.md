...
## Аналитика и конкурсные материалы 2.0
...
- **Реакция с 2038:** фиксация ранних годовых контрактов; невозможность адаптации
  показывается, а не скрывается отменой ранее размещённых заказов.
...
Результаты в [`results/`](results/); [протокол V01–V10 и E01–E15](docs/validation_protocol.md),
...
В UI нажмите «Рассчитать аналитику», затем выберите вкладку. «Открыть план»
